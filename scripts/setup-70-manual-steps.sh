...
echo ""
print_step "NetBird (browser login)"
echo "   - If setup did not start the daemon: sudo netbird service install --management-url https://netbird.smarties.app && sudo netbird service start"
